...
def start(update, context):
    ...
    context.bot.send_message(chat_id=update.effective_chat.id,
                             text='Привет! Скажем, А фитовал с В, а B c С. Тогда расстояние между исполнителями '
                                  ...
                                  'Если бот вам не отвечает, это значит, что пока что он ищет чей-то другой запрос. '
                                  'В таком случае не надо писать свой запрос еще раз, подождите, очередь дойдет '
                                  'и до вас.')
